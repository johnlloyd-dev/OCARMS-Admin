            ...
            <div class="container-fluid">
               <div class="card shadow mb-4">
                  <div class="card-header py-3">
                     <h3 class="m-0 text-primary">Summary Table - Goods Donation</h3>
                  </div>
                  <div class="card-body">
                     <div class="card">
...
<!------------------------------------ Donor Information End ------------------------------------>
                     ...
                     <hr style="width: 100%;">
                     <div class="row mt-3">
  <!------------------------------------ Goods Donation Start ------------------------------------>
                        <div class="col-12">
                           <div class="card mb-4">
                              <div class="card-header py-3">
                                 <h5 class="m-0 font-weight-bold text-danger">Goods Donations</h5>
                              </div>
                              <div class="card-body table-responsive">
                                 <div class="mb-5">
                                    <span class="pull-left mb-3">
                                       <a href="#addnew<?=$client_id;?>" data-toggle="modal" data-tooltip data-placement="bottom" title="Add goods donation from this donor"
                                 ...
                                 <hr>
                                 <?php include('includes/goods_campaign/add_goods_donation.php'); ?>
                                 <table id="example2" class="table table-bordered display border border-left-primary rounded" style="width:100%">
                                    <thead>
                                       <tr>
                                          <th>Date</th>
                                    ...
                                    <?php
                                       ...
                                       $query=mysqli_query($conn,"SELECT * FROM goods_donation WHERE client_id = $client_id");
                                       while($row=mysqli_fetch_array($query)){
                                    ?>
                                       <tr>
                                          <td><?php echo $row['donation_date'];?></td>
                                          <td><?php echo $row['goods_classification'];?></td>
                                          <td><?php echo $row['goods_description']; ?></td>
                                       ...
                                       <?php 
                                          include('includes/goods_campaign/update_donation_info.php');
                                          include('includes/goods_campaign/delete_donation_info.php');
                                          include('includes/goods_campaign/update_status.php');
                                          }
                                       ?>
                                    </tbody>
                                 </table>
