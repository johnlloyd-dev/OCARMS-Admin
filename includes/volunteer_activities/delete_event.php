...
<div class="modal fade" id="del<?php echo $row['ve_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
         <form method="POST" action="includes/volunteer_activities/connections.php">
            ...
            <div class="modal-footer">
               ...
               <button type="submit" name="deleteEvent" value="<?php echo $row['ve_id']; ?>" class="btn btn-danger btn-sm">
