...
<head>
   ...
   <title>Campaings for Goods Page</title>
   ...
   <div id="wrapper">
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <li class="nav-item active">
            <a class="nav-link" data-toggle="collapse" data-target="#collapseCampaigns" aria-expanded="true"
               aria-controls="collapseCampaigns">
               <i class="fas fa-fw fa-donate"></i>
               <span>Campaigns</span></a>
            <div id="collapseCampaigns" class="collapse show" aria-labelledby="headingUtilities"
               data-parent="#accordionSidebar">
               <div class="bg-white py-2 collapse-inner rounded">
                  <h6 class="collapse-header">Campaigns Details:</h6>
                  <a class="collapse-item active" href="campaign_goods.php"><i class="fas fa-fw fa-box-open"></i>
                     Goods</a>
                  <a class="collapse-item" href="campaign_monetory.php"><i class="fas fa-fw fa-money-bill-alt"></i>
                     Monetory</a>
               </div>
            </div>
         </li>
         <li class="nav-item">
            <a class="nav-link" href="volunteer_activities.php">
               ...
               <span>Volunteers Activities</span></a>
         </li>
         <li class="nav-item">
            ...
            <div class="container-fluid">
               <div class="card shadow mb-4">
                  <div class="card-header py-3">
                     <h3 class="m-0 text-primary">Goods Campaign - Benefactors</h3>
                  </div>
                  <div class="card-body">
                     <span class="pull-left mb-1">
                        <a href="#addnew" data-toggle="modal" data-tooltip data-placement="bottom" title="Add Donor"
                     ...
                     <?php include('includes/goods_campaign/add_goods_donor.php'); ?>
                     <div class="table-responsive">
                        <hr style="width: 100%;">
                        <table id="example" class="table table-bordered display border-left-primary rounded">
                           <thead>
                              <tr>
                                 <th>Donation Date</th>
                                 <th>Name</th>
                           ...
                           <?php
                                 ...
                                 $query=mysqli_query($conn,"SELECT * FROM goods_donation ORDER BY donation_id ASC"); 
                           ...
                           ?>
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    ?>
                                       <a data-toggle="modal" class="btn btn-primary btn-circle btn-sm" data-tooltip data-placement="bottom" title="You can't add another donation for this donor"><i class="fas fa-plus-circle"></i></a>
                                       <a href='#update_s<?=$row['donation_id'];?>' data-toggle="modal" class="btn btn-warning btn-circle btn-sm" data-tooltip data-placement="bottom" title="Update Status"><i class="fas fa-edit"></i></a>
                                    ...
                                    <?php
                                          ...
                                          ?>
                                          <a href="#add<?=$client_id;?>" data-toggle="modal" class="btn btn-primary btn-circle btn-sm" data-tooltip data-placement="bottom" title="Add goods donation for this donor"><i class="fas fa-plus-circle"></i></a>
                           ...
                           <?php include('includes/goods_campaign/update_donor_info.php'); ?>
                           <?php include('includes/goods_campaign/delete_donor_info.php'); ?>
                           <?php include('includes/goods_campaign/update_status.php'); ?>
                           <?php
                              }
                           ?>
                           </tbody>
